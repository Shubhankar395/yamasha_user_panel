!function(e, t) {
    ...
    "use strict";
    const D = "SweetAlert2:", q = (e)=>e.charAt(0).toUpperCase() + e.slice(1), i1 = (e)=>Array.prototype.slice.call(e), a1 = (e)=>{
        console.warn("".concat(D, " ").concat("object" == typeof e ? e.join(" ") : e));
    }, l1 = (e)=>{
        console.error("".concat(D, " ").concat(e));
    }, V = [], N = (e, t)=>{
        e = '"'.concat(e, '" is deprecated and will be removed in the next major release. Please use "').concat(t, '" instead.'), V.includes(e) || (V.push(e), a1(e));
    }, R = (e)=>"function" == typeof e ? e() : e, U = (e)=>e && "function" == typeof e.toPromise, u1 = (e)=>U(e) ? e.toPromise() : Promise.resolve(e), F = (e)=>e && Promise.resolve(e) === e, r1 = {
        title: "",
        titleText: "",
        text: "",
        html: "",
    ...
    ], _ = (e)=>Object.prototype.hasOwnProperty.call(r1, e), Y = (e)=>-1 !== W.indexOf(e), Z = (e)=>z[e], J = (e)=>{
        !e.backdrop && e.allowOutsideClick && a1('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`');
        for(const n in e)t = n, _(t) || a1('Unknown parameter "'.concat(t, '"')), e.toast && (t = n, K.includes(t) && a1('The parameter "'.concat(t, '" is incompatible with toasts'))), t = n, Z(t) && N(t, Z(t));
        var t;
    };
    var e1 = (e)=>{
        const t = {};
    ...
    const p = e1([
        ...
        "question",
        "error"
    ]), m = ()=>document.body.querySelector(".".concat(p.container)), t1 = (e)=>{
        const t = m();
        return t ? t.querySelector(e) : null;
    }, n1 = (e)=>t1(".".concat(e)), g = ()=>n1(p.popup), X = ()=>n1(p.icon), $ = ()=>n1(p.title), Q = ()=>n1(p["html-container"]), G = ()=>n1(p.image), ee = ()=>n1(p["progress-steps"]), te = ()=>n1(p["validation-message"]), h = ()=>t1(".".concat(p.actions, " .").concat(p.confirm)), f = ()=>t1(".".concat(p.actions, " .").concat(p.deny));
    const d1 = ()=>t1(".".concat(p.loader)), b = ()=>t1(".".concat(p.actions, " .").concat(p.cancel)), ne = ()=>n1(p.actions), oe = ()=>n1(p.footer), ie = ()=>n1(p["timer-progress-bar"]), ae = ()=>n1(p.close), re = ()=>{
        ...
        return ((t)=>{
            ...
            return n;
        })(e2.concat(t2)).filter((e)=>x(e));
    }, se = ()=>c1(document.body, p.shown) && !c1(document.body, p["toast-shown"]) && !c1(document.body, p["no-backdrop"]), ce = ()=>g() && c1(g(), p.toast);
    function le(e) {
    ...
    const s1 = {
        ...
        i1(t.classList).forEach((e)=>{
            Object.values(p).includes(e) || Object.values(o1).includes(e) || Object.values(n.showClass).includes(e) || t.classList.remove(e);
        });
    }, v = (e, t, n)=>{
        ...
        for(let e6 = 0; e6 < n.length; e6++)if (c1(n[e6], t)) return n[e6];
    }, A = (e, t, n)=>{
        ...
        t ? P(e, n) : B(e);
    }, x = (e)=>!(!e || !(e.offsetWidth || e.offsetHeight || e.getClientRects().length)), fe = ()=>!x(h()) && !x(f()) && !x(b()), be = (e)=>!!(e.scrollHeight > e.clientHeight), ye = (e)=>{
        ...
        const e = g(), t = k(e, p.input), n = k(e, p.file), o = e.querySelector(".".concat(p.range, " input")), i = e.querySelector(".".concat(p.range, " output")), a = k(e, p.select), r = e.querySelector(".".concat(p.checkbox, " input")), s = k(e, p.textarea);
        ...
        var n2, o2, i, a, r, s = ne(), c = d1();
        (t4.showConfirmButton || t4.showDenyButton || t4.showCancelButton ? P : B)(s), v(s, t4, "actions"), s, n2 = c, o2 = t4, i = h(), a = f(), r = b(), Ie(i, "confirm", o2), Ie(a, "deny", o2), Ie(r, "cancel", o2), function(e, t, n, o) {
            if (!o.buttonsStyling) return C([
                e,
                t,
                n
            ], p.styled);
            w([
                ...
                t,
                n
            ], p.styled), o.confirmButtonColor && (e.style.backgroundColor = o.confirmButtonColor, w(e, p["default-outline"]));
        ...
        }(i, a, r, o2), o2.reverseButtons && (o2.toast ? (s.insertBefore(r, i), s.insertBefore(a, i)) : (s.insertBefore(r, n2), s.insertBefore(a, n2), s.insertBefore(i, n2))), y(c, t4.loaderHtml), v(c, t4, "loader");
    };
    function Ie(e, t, n) {
    ...
    const He = (e, t)=>{
        var n, o, i = m();
        i && (o = i, "string" == typeof (n = t.backdrop) ? o.style.background = n : n || w([
            document.documentElement,
            document.body
        ], p["no-backdrop"]), o = i, (n = t.position) in p ? w(o, p[n]) : (a1('The "position" parameter is not valid, defaulting to "center"'), w(o, p.center)), n = i, (o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in p && w(n, p[o]), v(i, t, "container"));
    };
    var S = {
    ...
    const De = [
        ...
        const s = g();
        var t5, e8 = S.innerParams.get(e8);
        ...
        De.forEach((e)=>{
            ...
            if (!L[e.input]) return l1('Unexpected type of input! Expected "text", "email", "password", "number", "tel", "select", "radio", "checkbox", "textarea", "file" or "url", got "'.concat(e.input, '"'));
            const t = Ue(e.input), n = L[e.input](t, e);
            P(t), setTimeout(()=>{
                pe(n);
            });
        })(r), e8 = r, t5 = Ue(e8.input), "object" == typeof e8.customClass && w(t5, e8.customClass.input));
    }, Ve = (t)=>{
        ...
        [
            "string",
            "number"
        ].includes(typeof t) ? e.value = "".concat(t) : F(t) || a1('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof t, '"'));
    }, L = {}, We = (L.text = L.email = L.password = L.number = L.tel = L.url = (e, t)=>(Fe(e, t.inputValue), Re(e, e, t), Ne(e, t), e.type = t.input, e), L.file = (e, t)=>(Re(e, e, t), Ne(e, t), e), L.range = (e, t)=>{
        ...
        Fe(n, e9.inputValue), Ne(n, e9), Re(n, n, e9);
        return setTimeout(()=>{
        ...
        if (t.icon || t.iconHtml) {
            if (t.icon && -1 === Object.keys(o1).indexOf(t.icon)) return l1('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), void B(n);
            P(n), $e(n, t), Ye(n, t), w(n, t.showClass.icon);
        } else B(n);
    }, Ye = (e, t)=>{
        for(const n in o1)t.icon !== n && C(e, o1[n]);
        w(e, o1[t.icon]), Qe(e, t), Ze(), v(e, t, "icon");
    }, Ze = ()=>{
        const e = g();
        ...
        P(o), o.textContent = "", n.currentProgressStep >= n.progressSteps.length && a1("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), n.progressSteps.forEach((e12, t6)=>{
            var e12 = ((e)=>{
                const t = document.createElement("li");
                return w(t, p["progress-step"]), y(t, e), t;
            })(e12);
            o.appendChild(e12), t6 === n.currentProgressStep && w(e12, p["active-progress-step"]), t6 !== n.progressSteps.length - 1 && (e12 = ((e)=>{
                const t = document.createElement("li");
        ...
        var n = m();
        const o = g();
        t.toast ? (A(n, "width", t.width), o.style.width = "100%", o.insertBefore(d1(), X())) : A(o, "width", t.width), A(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), B(te());
        n = o;
        (n.className = "".concat(p.popup, " ").concat(x(n) ? t.showClass.popup : ""), t.toast) ? (w([
            document.documentElement,
            document.body
        ], p["toast-shown"]), w(n, p.toast)) : w(n, p.modal);
        ...
        const n = {}, t7 = e17.querySelector("swal-input");
        t7 && (j(t7, [
            "type",
            "label",
            "placeholder",
            "value"
        ]), n.input = t7.getAttribute("type") || "text", t7.hasAttribute("label") && (n.inputLabel = t7.getAttribute("label")), t7.hasAttribute("placeholder") && (n.inputPlaceholder = t7.getAttribute("placeholder")), t7.hasAttribute("value") && (n.inputValue = t7.getAttribute("value")));
        e17 = e17.querySelectorAll("swal-input-option");
        return e17.length && (n.inputOptions = {}, i1(e17).forEach((e)=>{
            j(e, [
                "value"
            ]);
    ...
    function ft(e19) {
        (t = e19).inputValidator || Object.keys(ht).forEach((e)=>{
        ...
        var t, n = e19, e19 = Pe();
        if (ve()) l1("SweetAlert2 requires document to initialize");
        else {
            const o = document.createElement("div"), i = (o.className = p.container, e19 && w(o, p["no-transition"]), y(o, Ae), xe(n.target));
    ...
    const yt = ()=>{
        null === s1.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (s1.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = "".concat(s1.previousBodyPadding + (()=>{
        ...
        null !== s1.previousBodyPadding && (document.body.style.paddingRight = "".concat(s1.previousBodyPadding, "px"), s1.previousBodyPadding = null);
    }, wt = ()=>{
        if ((/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream || "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints) && !c1(document.body, p.iosfix)) {
            var e20, t = document.body.scrollTop;
            ...
            }
            {
                ...
                r && (e20 = 44, g().scrollHeight > window.innerHeight - 44 && (m().style.paddingBottom = "".concat(44, "px")));
            }
        }
    }, Ct = (e)=>{
        ...
        var e;
        c1(document.body, p.iosfix) && (e = parseInt(document.body.style.top, 10), C(document.body, p.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e);
    }, At = 10, Pt = (e)=>{
        const t = g();
        if (e.target === t) {
            const n = m();
        ...
        w(e, n.showClass.backdrop), t.style.setProperty("opacity", "0", "important"), P(t, "grid"), setTimeout(()=>{
            ...
            document.documentElement,
            document.body
        ], p.shown), n.heightAuto && n.backdrop && !n.toast && w([
            document.documentElement,
            document.body
        ], p["height-auto"]);
    }, M = (e)=>{
        ...
        if (ce()) B(X());
            ...
            a.parentNode.insertBefore(a, e), w([
                o,
                i
            ], p.loading);
        }
        ...
        U(n.inputOptions) || F(n.inputOptions) ? (M(h()), u1(n.inputOptions).then((e)=>{
            t.hideLoading(), i(e);
        })) : "object" == typeof n.inputOptions ? i(n.inputOptions) : l1("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof n.inputOptions));
    }, St = (t, n)=>{
        const o = t.getInput();
        B(o), u1(n.inputValue).then((e)=>{
            o.value = "number" === n.input ? parseFloat(e) || 0 : "".concat(e), P(o), o.focus(), t.hideLoading();
        }).catch((e)=>{
            l1("Error in inputValue promise: ".concat(e)), o.value = "", P(o), o.focus(), t.hideLoading();
        });
    }, Lt = {
        select: (e22, t8, i)=>{
            const a = k(e22, p.select), r = (e, t, n)=>{
        ...
        radio: (e24, t9, a)=>{
            const r = k(e24, p.radio), n3 = (t9.forEach((e)=>{
                var t = e[0], e = e[1];
                const n = document.createElement("input"), o = document.createElement("label"), i = (n.type = "radio", n.name = p.radio, n.value = t, jt(t, a.inputValue) && (n.checked = !0), document.createElement("span"));
        ...
        return "undefined" != typeof Map && n4 instanceof Map ? n4.forEach((e, t)=>{
            let n = e;
            "object" == typeof n && (n = Ot(n)), o.push([
                t,
                n
            ]);
        }) : Object.keys(n4).forEach((e)=>{
            let t = n4[e];
            "object" == typeof t && (t = Ot(t)), o.push([
                e,
                t
            ]);
        }), o;
    ...
    function Mt() {
        ...
        if (t) {
            ...
            B(n.loader), ce() ? t.icon && P(X()) : (t = n, (e = t.popup.getElementsByClassName(t.loader.getAttribute("data-button-to-replace"))).length ? P(e[0], "inline-block") : fe() && B(t.actions)), C([
                n.popup,
                n.actions
    ...
    const Dt = (e)=>{
        ...
        if (o && !n.isComposing && 229 !== n.keyCode) {
            if (o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key) e, s = n, i = o, R(i.allowEnterKey) && s.target && e.getInput() && s.target instanceof HTMLElement && s.target.outerHTML === e.getInput().outerHTML && ([
                "textarea",
                "file"
            ].includes(i.input) || (Ht(), s.preventDefault()));
            else if ("Tab" === n.key) {
                e = n;
                var i = o;
                var a = e.target, r = re();
                let t = -1;
                for(let e25 = 0; e25 < r.length; e25++)if (a === r[e25]) {
                    t = e25;
                    break;
                }
    ...
    function Ut(e, t, n, o) {
        ce() ? Kt(e, o) : (ke(n).then(()=>Kt(e, o)), Dt(E)), /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ? (t.setAttribute("style", "display:none !important"), t.removeAttribute("class"), t.innerHTML = "") : t.remove(), se() && (vt(), kt(), rt()), C([
            document.documentElement,
            document.body
        ], [
            p.shown,
    ...
    function Ft(e27) {
        e27 = void 0 !== (n5 = e27) ? Object.assign({
            isConfirmed: !1,
            isDenied: !1,
            isDismissed: !1
        }, n5) : {
        ...
        const t10 = It.swalPromiseResolve.get(this);
        var n5 = ((e)=>{
            const t = g();
            if (!t) return false;
            const n = S.innerParams.get(e);
            if (!n || c1(t, n.hideClass.popup)) return false;
            C(t, n.showClass.popup), w(t, n.hideClass.popup);
            const o = m();
            return C(o, n.showClass.backdrop), w(o, n.hideClass.backdrop), zt(e, t, n), true;
        })(this);
        this.isAwaitingPromise() ? e27.isDismissed || (Wt(this), t10(e27)) : n5 && t10(e27);
    }
    const Wt = (e)=>{
        e.isAwaitingPromise() && (S.awaitingPromise.delete(e), S.innerParams.get(e) || e._destroy());
    }, zt = (e28, t, n)=>{
        var o, i, a, r = m(), s = je && ye(t);
        "function" == typeof n.willClose && n.willClose(t), s ? (s = e28, o = t, t = r, i = n.returnFocus, a = n.didClose, E.swalCloseEventFinishedCallback = Ut.bind(null, s, t, i, a), o.addEventListener(je, function(e) {
            e.target === o && (E.swalCloseEventFinishedCallback(), delete E.swalCloseEventFinishedCallback);
        })) : Ut(e28, r, n.returnFocus, n.didClose);
    }, Kt = (e, t)=>{
        setTimeout(()=>{
    ...
    function Yt(e, t) {
        ...
        if ("radio" === e.type) {
            ...
            for(let e30 = 0; e30 < o.length; e30++)o[e30].disabled = t;
        } else e.disabled = t;
    }
    const Zt = (e)=>{
    ...
    e1 = Object.freeze({
        ...
        update: function(e31) {
            var t11 = g(), n6 = S.innerParams.get(this);
            if (!t11 || c1(t11, n6.hideClass.popup)) return a1("You're trying to update the closed or closing popup, that won't work. Use the update() method in preConfirm parameter or show a new popup.");
            t11 = ((t)=>{
                const n = {};
                return Object.keys(t).forEach((e)=>{
                    if (Y(e)) n[e] = t[e];
                    else a1("Invalid parameter to update: ".concat(e));
                }), n;
            })(e31), n6 = Object.assign({}, n6, t11), it(this, n6), S.innerParams.set(this, n6), Object.defineProperties(this, {
                params: {
                    value: Object.assign({}, this.params, e31),
                    writable: !1,
                    enumerable: !0
                }
            });
    ...
    const Xt = (e32, t12)=>{
        var n7 = S.innerParams.get(e32);
        if (!n7.input) return l1('The "input" parameter is needed to be set when using returnInputValueOn'.concat(q(t12)));
        var o3 = ((e, t)=>{
            const n = e.getInput();
            if (!n) return null;
            switch(t.input){
        ...
        if (n7.inputValidator) {
            var i = e32;
            var a = o3;
            var r = t12;
            const s = S.innerParams.get(i), c = (i.disableInput(), Promise.resolve().then(()=>u1(s.inputValidator(a, s.validationMessage))));
            c.then((e)=>{
                i.enableButtons(), i.enableInput(), e ? i.showValidationMessage(e) : ("deny" === r ? $t : en)(i, a);
            });
        } else e32.getInput().checkValidity() ? ("deny" === t12 ? $t : en)(e32, o3) : (e32.enableButtons(), e32.showValidationMessage(n7.validationMessage));
    }, $t = (t, n)=>{
        const e33 = S.innerParams.get(t || void 0);
        if (e33.showLoaderOnDeny && M(f()), e33.preDeny) {
            S.awaitingPromise.set(t || void 0, !0);
            const o = Promise.resolve().then(()=>u1(e33.preDeny(n, e33.validationMessage)));
            o.then((e)=>{
        ...
        const e34 = S.innerParams.get(t || void 0);
        if (e34.showLoaderOnConfirm && M(), e34.preConfirm) {
            t.resetValidationMessage(), S.awaitingPromise.set(t || void 0, !0);
            const o = Promise.resolve().then(()=>u1(e34.preConfirm(n, e34.validationMessage)));
            o.then((e)=>{
    ...
    var gn = Object.freeze({
        ...
        argsToParams: (n)=>{
            const o = {};
            return "object" != typeof n[0] || cn(n[0]) ? [
                "title",
                "html",
                "icon"
            ].forEach((e, t)=>{
                t = n[t];
                "string" == typeof t || cn(t) ? o[e] = t : void 0 !== t && l1("Unexpected type of ".concat(e, '! Expected "string" or "Element", got ').concat(typeof t));
        ...
        getImage: G,
        getIcon: X,
        getInputLabel: ()=>n1(p["input-label"]),
        getCloseButton: ae,
        getActions: ne,
        getConfirmButton: h,
        getDenyButton: f,
    ...
    class H {
        ...
        _main(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {}, e = (J(Object.assign({}, t, e)), E.currentInstance && (E.currentInstance._destroy(), se() && rt()), E.currentInstance = I, fn(e, t)), t = (ft(e), Object.freeze(e), E.timeout && (E.timeout.stop(), delete E.timeout), clearTimeout(E.restoreFocusTimeout), bn(I));
    ...
    const hn = (l, u, d)=>new Promise((e37, t13)=>{
            const n = (e)=>{
                l.closePopup({
                    isDismissed: !0,
                    dismiss: e
            ...
            var o, i, a;
            It.swalPromiseResolve.set(l, e37), It.swalPromiseReject.set(l, t13), u.confirmButton.onclick = ()=>{
            ...
            }, u.closeButton.onclick = ()=>n(O.close), e37 = l, t13 = u, a = n, S.innerParams.get(e37).toast ? tn(e37, t13, a) : (on(t13), an(t13), rn(e37, t13, a)), o = l, e37 = E, t13 = d, i = n, Dt(e37), t13.toast || (e37.keydownHandler = (e)=>Rt(o, e, i), e37.keydownTarget = t13.keydownListenerCapture ? window : g(), e37.keydownListenerCapture = t13.keydownListenerCapture, e37.keydownTarget.addEventListener("keydown", e37.keydownHandler, {
                capture: e37.keydownListenerCapture
            }), e37.keydownHandlerAdded = !0), a = l, "select" === (t13 = d).input || "radio" === t13.input ? Tt(a, t13) : [
                "text",
                "email",
                "number",
                "tel",
                "textarea"
            ].includes(t13.input) && (U(t13.inputValue) || F(t13.inputValue)) && (M(h()), St(a, t13));
            {
                var r = d;
                const s = m(), c = g();
                "function" == typeof r.willOpen && r.willOpen(c), e37 = window.getComputedStyle(document.body).overflowY, Et(s, c, r), setTimeout(()=>{
                    Bt(s, c);
                }, At), se() && (xt(s, r.scrollbarPadding, e37), at()), ce() || E.previousActiveElement || (E.previousActiveElement = document.activeElement), "function" == typeof r.didOpen && setTimeout(()=>r.didOpen(c)), C(s, p["no-transition"]);
            }
        ...
        const o = Object.assign({}, r1, t, n, e38);
        return o.showClass = Object.assign({}, r1.showClass, o.showClass), o.hideClass = Object.assign({}, r1.hideClass, o.hideClass), o;
    }, bn = (e)=>{
        var t = {
            popup: g(),
            container: m(),
    ...
    }, wn = (e, t)=>t.focusDeny && x(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && x(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !x(e.confirmButton)) && (e.confirmButton.focus(), !0), Cn = ()=>{
        document.activeElement instanceof HTMLElement && "function" == typeof document.activeElement.blur && document.activeElement.blur();
    }, kn = (Object.assign(H.prototype, e1), Object.assign(H, gn), Object.keys(e1).forEach((e)=>{
        H[e] = function() {
...
//# sourceMappingURL=watch_list.4c4594dc.js.map
