...
// check login
function loginCheck() {
    if (!store.get("yamasha_user_data")) location.replace("./login.html");
}
// logout function
function logOut() {
...
function d_none(div_id, status) {
    if (status == true) div_id.classList.add("d-none");
    if (status == false) div_id.classList.remove("d-none");
}
...
//# sourceMappingURL=watch_list.b8ac48d9.js.map
